...
function fijarMeta(nombre: string, contenido: string, esProperty = false) {
...
function fijarJsonLd(datos: object) {
...
function useSeo({ titulo, descripcion, canonical, ogImage, jsonLd, noIndex = false }: ArgsSeo) {
  useEffect(() => {
